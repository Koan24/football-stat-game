...
function PlayerModal({
  ...
  useEffect(() => {
    ...
    if (currentSelection) {
      setSelectedPlayer(currentSelection.player)
      setSelectedSeasonId(String(currentSelection.season.id))
    } else {
  ...
  const handleConfirm = () => {
    if (!selectedPlayer || !selectedSeason) {
      setToastMessage("Wybierz zawodnika oraz jeden z jego sezonów.")
      return
    }
